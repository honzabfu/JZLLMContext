...
- **Markdown / prostý text** — globální přepínač v nastavení; výsledek lze zobrazit jako formátovaný Markdown nebo jako prostý text
...
- **Zobrazit výsledek jako Markdown** — pokud je zapnuto (výchozí), výsledek se renderuje jako formátovaný Markdown (nadpisy, tučný text, kód, …); při vypnutí se zobrazí jako prostý text.
